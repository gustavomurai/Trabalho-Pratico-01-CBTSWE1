...
* **MySQL:** Armazenamento persistente de dados (Tabela `user905`).
...
2. Certifique-se de que o banco de dados `swii5` e a tabela `user905` estejam criados no seu MySQL.
...
---
*Este projeto foi realizado por Gustavo Murai e Igor Murai para a matéria de Sistemas Web 1.*
